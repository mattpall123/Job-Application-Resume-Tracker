...
export default function CoverLetterInput({ onChange, resetAfterUpload = false }) {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      const response = await axios.post('/api/jobs/cover-letter/upload', formData, {
      ...
      // Pass data back up to parent component
  ...
  const handleRemove = async () => {
    try {
      await axios.delete(`/api/jobs/cover-letter/${filename}`);
    } catch (error) {
